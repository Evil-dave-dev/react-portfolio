  ...
  return (
    ...
    >
      ...
      >
        ...
        <stop offset=".7" stopColor="#a52714" stopOpacity="0" />
      </linearGradient>
      <linearGradient
        id="f"
        x1="109.9"
      ...
      >
        ...
        <stop offset=".3" stopColor="#055524" stopOpacity="0" />
      </linearGradient>
      <linearGradient
        id="h"
        x1="121.9"
      ...
      >
        ...
        <stop offset=".7" stopColor="#ea6100" stopOpacity="0" />
      </linearGradient>
      <radialGradient
        id="a"
        cx="91.2"
      ...
      <radialGradient id="i" cx="20.9" cy="47.5" r="78" xlinkHref="#a" />
      <radialGradient
        id="j"
        cx="94.8"
        cy="95.1"
      ...
      <g clipPath="url(#b)">
        <use fill="#db4437" xlinkHref="#c" />
        <use fill="url(#d)" xlinkHref="#c" />
        <use fill="#0f9d58" xlinkHref="#e" />
        <use fill="url(#f)" xlinkHref="#e" />
        <use fill="#ffcd40" xlinkHref="#g" />
